...
class Articles extends Migration
{
    ...
    public function up()
    {
        Schema::create('articles', function (Blueprint $table) {
            ...
            $table->string('content', 6000)->nullable(false)->comment('');
            $table->string('content_raw', 4000)->nullable(false)->comment('');
            $table->char('author_id', 36)->nullable()->default(null)->comment('');
            $table->char('topic_id', 36)->nullable(true)->default(null)->comment('');
